...
<body>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Dellate de vehiculos</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Inico</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Detalle de vehiculos</h6>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-5">
                    <div class="bg-secondary p-5">
                        <h3 class="text-primary text-center mb-4">Combrobar disponibilidad</h3>
        ...
        <div class="container pb-5">
            ...
            <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                ...
                <div class="rent-item">
                    ...
                    <h4 class="text-uppercase mb-4">Mercedes Benz R4</h4>
                    <div class="d-flex justify-content-center mb-4">
                        <div class="px-2">
                            <i class="fa fa-car text-primary mr-1"></i>
                            <span>2015</span>
