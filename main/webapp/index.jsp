...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">AMERICA RENT CAR</h4>
                            <h1 class="display-1 text-white mb-md-4">Los mejores coches al alcance de tu ubicacion</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">AMERCIA RENT CAR</h4>
                            <h1 class="display-1 text-white mb-md-4">Coches de alta calidad con millas ilimitadas</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Reserva ahora</a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Inico de informacion-->
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-1 text-primary text-center">01</h1>
            <h1 class="display-4 text-uppercase text-center mb-5">Bienvenidos a <span class="text-primary">AMERCIA RENT CAR</span></h1>
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="img/about.png" alt="">
                    <p>El alquiler de vehiculos es un servicio que permite a alas personas o empresas alquilar temporalmente automoviles, motocicletas,furgonetas  otros tipos de vehiculos para satisfacer las necesidades de transporte, este servicio quiere proporcionar a los usuarios flexibilidad al utilizar el vehiculo en un periodo especifico con opciones variables de vehiculos, economicos hasta vehiculos de lujko entre otros... </p>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">24/7 Soporte de vehiculos</h4>
                    </div>
                </div>
                <div class="col-lg-4 mb-2">
                ...
                <div class="col-lg-4 mb-2">
                    <div class="d-flex align-items-center bg-light p-4 mb-4" style="height: 150px;">
                        ...
                        <h4 class="text-uppercase m-0">Muchos lugares de recogida</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Selecciona tu coche</h1>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="">$99.00/Dia</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-2">
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-secondary d-flex align-items-center justify-content-between" style="height: 350px;">
                        ...
                        <div class="text-right">
                            <h3 class="text-uppercase text-light mb-3">Quieres ser conduct@r?</h3>
                            <p class="mb-4">Maneja con los mejores coches siempre a tu disposicion</p>
                            <a class="btn btn-primary py-2 px-4" href="">Reserva ahora</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 px-0">
                    <div class="px-5 bg-dark d-flex align-items-center justify-content-between" style="height: 350px;">
                        <div class="text-left">
                            <h3 class="text-uppercase text-light mb-3">Buscando un coche?</h3>
                            <p class="mb-4">Este es tu momento justo para realizar una reservacion</p>
                            <a class="btn btn-primary py-2 px-4" href="">Reseva ahora</a>
                        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">La opinion de nuestros clientes</h1>
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    ...
                    <h4 class="text-uppercase mb-2">Cristian</h4>
                    <i class="mb-2">Arquitecto</i>
                    <p class="m-0">Me encanto la comodidad de los vehiculos y su atencion</p>
                </div>
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h4 class="text-uppercase mb-2">Maria</h4>
                    <i class="mb-2">Ingeniera civil</i>
                    <p class="m-0">Fue increible mi experiencia con estos vehiculos, pude dar un paseo fue lo maximo!!</p>
                </div>
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h4 class="text-uppercase mb-2">Cristofer</h4>
                    <i class="mb-2">Licenciado</i>
                    <p class="m-0">Me gusto la comodidad de los horarios y los lugares donde podia realizar la entraga</p>
                </div>
                <div class="testimonial-item d-flex flex-column justify-content-center px-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h4 class="text-uppercase mb-2">Andrea</h4>
                    <i class="mb-2">Veterinaria</i>
                    <p class="m-0">Me gusto lo facil que fue realizar la reservacion y la atencion del personal, recomendadisimo!</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action="RegistroSolicitud" method="POST">
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" class="form-control p-4" placeholder="Nombre" required="required" name="nombre">
                                </div>
                                <div class="col-6 form-group">
                                    <input type="email" class="form-control p-4" placeholder="Correo" required="required" name="correo">
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="Asunto" required="required" name="asunto" >
                            </div>
                             <div class="form-group">
                                <input type="text" class="form-control p-4" placeholder="vehiculo seleccionado" required="required" name="vehiculo" >
                            </div>
                            <div class="form-group">
                                <textarea class="form-control py-3 px-4" rows="5" placeholder="Mensaje" required="required" name="mensaje"></textarea>
                            </div>
                            <div>
